...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/tokjrtest#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/tokjrtest
```

A live public deployment of this template is available at [https://tokjrtest.templates.workers.dev](https://tokjrtest.templates.workers.dev)
